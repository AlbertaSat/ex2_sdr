...
class endurosat_e2e(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate_0 = samp_rate_0 = spsym*baud_bit
        self.samp_rate = samp_rate = spsym*baud_bit
        self.rx_gain = rx_gain = 40
        self.center_freq = center_freq = 437875000
        self.baud_byte = baud_byte = baud_bit/8
        self.attenuation_db = attenuation_db = 0

        ##################################################
        # Blocks
        ##################################################
        self._attenuation_db_range = Range(0, 10, 0.1, 0, 200)
        self._attenuation_db_win = RangeWidget(self._attenuation_db_range, self.set_attenuation_db, "attenuation_db", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._attenuation_db_win)
        ...
        self.satellites_rms_agc_0 = satellites.hier.rms_agc(alpha=1/baud_bit, reference=0.5)
        ...
        self.qtgui_time_sink_x_1_0.set_y_label('AGC', "")
        ...
        self.qtgui_time_sink_x_1.set_y_label('No AGC', "")
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(10**(-attenuation_db/10))
        ...
        self.connect((self.satellites_rms_agc_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.satellites_rms_agc_0, 0), (self.satellites_fsk_demodulator_0, 0))
    ...
    def set_spsym(self, spsym):
        self.spsym = spsym
        self.set_samp_rate(self.spsym*self.baud_bit)
        self.set_samp_rate_0(self.spsym*self.baud_bit)
    ...
    def set_baud_bit(self, baud_bit):
        ...
        self.set_samp_rate_0(self.spsym*self.baud_bit)
        self.set_sensitivity(2*3.14159*(self.fsk_dev/(self.baud_bit*self.spsym)))
        self.satellites_rms_agc_0.set_alpha(1/self.baud_bit)
        self.uhd_usrp_sink_0.set_samp_rate(self.baud_bit*self.spsym)
        self.uhd_usrp_source_0_0.set_samp_rate(self.baud_bit*self.spsym)
    ...
    def set_attenuation_db(self, attenuation_db):
        self.attenuation_db = attenuation_db
        self.blocks_multiply_const_vxx_0.set_k(10**(-self.attenuation_db/10))
