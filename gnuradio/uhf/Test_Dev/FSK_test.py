...
class FSK_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FSK_test")
        ...
        self.blocks_random_pdu_0 = blocks.random_pdu(50, 2000, 0xFF, 1)
        ...
        self.analog_frequency_modulator_fc_0 = analog.frequency_modulator_fc(sensitivity_tx)
    ...
    def set_sensitivity_tx(self, sensitivity_tx):
        ...
        self.analog_frequency_modulator_fc_0.set_sensitivity(self.sensitivity_tx)
...
def main(top_block_cls=FSK_test, options=None):
