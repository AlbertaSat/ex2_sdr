...
class Grant_F_sig_gen(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._tx_gain_range = Range(0, 79, 1, 40, 200)
        self._tx_gain_win = RangeWidget(self._tx_gain_range, self.set_tx_gain, "TX Gain [0,79]", "counter_slider", int, QtCore.Qt.Horizontal)
