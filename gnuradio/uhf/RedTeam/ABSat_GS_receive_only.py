...
class ABSat_GS_receive_only(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ABSat_GS_receive_only")
        ...
        # Blocks
        ##################################################
        self._rx_gain_range = Range(0, 89, 1, 30, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'RedTeam20230628_test01', False)
...
def main(top_block_cls=ABSat_GS_receive_only, options=None):
