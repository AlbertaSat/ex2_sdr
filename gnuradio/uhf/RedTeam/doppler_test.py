...
class doppler_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "doppler_test")
        ...
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, center_freq_rx)
    ...
    def set_center_freq_rx(self, center_freq_rx):
        ...
        self.analog_const_source_x_0.set_offset(self.center_freq_rx)




def main(top_block_cls=doppler_test, options=None):
