...
# Title: Northern SPIRIT Receiver with beacon decode
# Author: knud
...
class ns_esttc_receiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Northern SPIRIT Receiver with beacon decode", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Northern SPIRIT Receiver with beacon decode")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ns_esttc_receiver")
...
def main(top_block_cls=ns_esttc_receiver, options=None):
