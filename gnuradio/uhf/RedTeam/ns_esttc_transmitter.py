...
# Title: Northern SPIRIT Transmitter
# Author: knud
...
class ns_esttc_transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Northern SPIRIT Transmitter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Northern SPIRIT Transmitter")
        ...
        self.uhd_usrp_sink_0_0.set_center_freq(center_freq_tx, 0)
    ...
    def set_center_freq_tx(self, center_freq_tx):
        ...
        self.uhd_usrp_sink_0_0.set_center_freq(self.center_freq_tx, 0)
