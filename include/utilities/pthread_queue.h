...
*/
#define PTHREAD_QUEUE_ERROR OS_QUEUE_ERROR
/**
   Queue is empty - cannot extract element.
*/
#define PTHREAD_QUEUE_EMPTY OS_QUEUE_ERROR
/**
   Queue is full - cannot insert element.
*/
#define PTHREAD_QUEUE_FULL OS_QUEUE_ERROR
/**
   Ok - no error.
*/
#define PTHREAD_QUEUE_OK OS_QUEUE_OK
/** @{ */
